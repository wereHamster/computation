...
- **Add explicit types and import conditions to exports** ([#495](https://github.com/wereHamster/computation/pull/495)) - This improves TypeScript IntelliSense and module resolution for modern build tools.
